...
public class DistancePoint2SegmentAtLeast implements IConstraint {

	public DistancePoint2SegmentAtLeast(VarIntCP x, VarIntCP y, VarIntCP xA, VarIntCP yA, VarIntCP xB, VarIntCP yB, double threshold){
		//semantic: distance from (x,y) to segment (xA,yA)-(xB,yB) must be at least threshold
	}
	@Override
