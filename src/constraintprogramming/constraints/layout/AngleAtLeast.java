...
public class AngleAtLeast implements IConstraint {

	public AngleAtLeast(VarIntCP xA, VarIntCP yA, VarIntCP xB, VarIntCP yB, VarIntCP xC, VarIntCP yC, double alpha){
		// semantic: the angle (ABC) must be greater than or equal to alpha
