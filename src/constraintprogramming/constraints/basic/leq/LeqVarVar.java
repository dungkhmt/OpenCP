...
public class LeqVarVar implements IConstraint {
	...
	public LeqVarVar(VarIntCP x, VarIntCP y){
		// semantic: x <= y
		_x = x; _y = y;
		_dx = 0; _dy = 0;
	...
	public LeqVarVar(VarIntCP x, int dx, VarIntCP y, int dy){
		// semantic: x + dx <= y + dy
		_x = x; _y = y;
		_dx = dx; _dy = dy;
		_vars = new VarIntCP[2];
	...
	public LeqVarVar(VarIntCP x, int dx, VarIntCP y){
		// semantic: x + dx <= y
		_x = x; _y = y;
		_dx = dx; _dy = 0;
		_vars = new VarIntCP[2];
	...
	public LeqVarVar(VarIntCP x, VarIntCP y, int dy){
		// semantic: x <= y + dy
		_x = x; _y = y;
		_dx = 0; _dy = dy;
		_vars = new VarIntCP[2];
	...
	@Override
	public String name(){
		String s = "LeqVarVar(" + _x.name() + "," + _dx + "," + _y.name() + "," + _dy + ")";
		return s;
	}
	/**
	 * @param args
